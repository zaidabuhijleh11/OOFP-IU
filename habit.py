...
class Habit:
    ...
    def habit_is_done_today(self, name: str ) -> None:
    ...
    def longest_run_streak_for_a_given_habit(self, name: str) -> int:
        ...
        streak_history = []
        consecutive_dates = []
        gap = 1 if db.get_period(name) == 'daily' else 7  # Daily streak or weekly streak
        for x in range(1, len(dates)):
